...
<%--                request.setAttribute("emailClass", emailClass);--%>
                ...
                <%--                <%--%>
                <%--                    String emailerror = (String) request.getAttribute("Emailerror");--%>
                <%--                    String emailClass = (emailerror != null) ? "emallerror" : ""; // Nếu có lỗi email, đặt emailClass thành "error"--%>

                <%--                    request.setAttribute("emailClass", emailClass);--%>
                <%--                %>--%>

                <input type="text" name="username" id="username" class="username <%= emailClass %>>"
